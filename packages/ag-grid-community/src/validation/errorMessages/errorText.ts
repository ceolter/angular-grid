...
export const AG_GRID_ERRORS = {
    ...
    111: () =>
        'Invalid selection state. When `groupSelects` is either "descendants" or "filteredDescendants", the state must conform to `IServerSideGroupSelectionState`.' as const,
