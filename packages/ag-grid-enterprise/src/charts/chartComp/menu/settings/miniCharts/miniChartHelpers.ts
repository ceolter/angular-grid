...
export function createPath(agChartsContext: AgChartsContext, commands: CommandSegment[]): any {
...
export function createAreaPaths(
    ...
    const paths: any[] = pathCommands.map((commands) => createPath(agChartsContext, commands));
