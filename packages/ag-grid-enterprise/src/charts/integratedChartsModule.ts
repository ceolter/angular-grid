...
import { _DragAndDropModule, _PopupModule, _errMsg } from 'ag-grid-community';
...
const baseIntegratedChartsModule: _ModuleWithApi<_GridChartsGridApi> = {
    ...
    dependsOn: [CellSelectionModule, EnterpriseCoreModule, _DragAndDropModule, _PopupModule, MenuItemModule],
