...
import { CellFlashModule, CsvExportModule, _KeyboardNavigationModule } from 'ag-grid-community';
...
export const ClipboardModule: _ModuleWithApi<_ClipboardGridApi> = {
    ...
    dependsOn: [EnterpriseCoreModule, CsvExportModule, _KeyboardNavigationModule, CellFlashModule],
};
