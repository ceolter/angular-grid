...
import { _DragAndDropModule, _FilterCoreModule, _FilterValueModule, _PopupModule } from 'ag-grid-community';
...
export const AdvancedFilterModule: _ModuleWithApi<_AdvancedFilterGridApi> = {
    ...
    dependsOn: [EnterpriseCoreModule, _FilterCoreModule, _DragAndDropModule, _PopupModule, _FilterValueModule],
